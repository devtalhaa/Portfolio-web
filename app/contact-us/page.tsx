            ...
            <div className="max-w-6xl mx-auto">
                <div className="grid md:grid-cols-2 gap-16">
                    ...
                    <div className="contact-info">
                        ...
                        >
                            Let's <span style={{ color: theme.colors.primary.DEFAULT }}>Connect</span>
                        </h1>
                        <p
                        ...
                        <div className="space-y-6">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <p style={{ color: theme.colors.text.placeholder }} className="text-sm">Email</p>
                                    <a
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <p style={{ color: theme.colors.text.placeholder }} className="text-sm">Location</p>
                                    <p style={{ color: theme.colors.text.primary }}>Lahore, Pakistan</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <p style={{ color: theme.colors.text.placeholder }} className="text-sm">LinkedIn</p>
                                    <a
                    ...
                    <Card className="md:p-10">
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <Button
                                ...
                                style={{
                                    backgroundColor: isSubmitted ? theme.colors.success : undefined,
                                }}
                            >
